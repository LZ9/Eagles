    ...
    public void detachFromGLContext() {
        try {
            ...
            try {
                ...
                Log.d(TAG, "nativeDetachFromGLContext invoke retCode:" + retCode);
            } catch (Exception e) {
                Log.e(TAG, "nativeDetachFromGLContext invoke exception:" + e.getMessage());
            }
            Log.e(TAG, "mSurface.detachFromGLContext() exception:" + ex.getMessage());
        }
    }
